...
| Dust packs | `platform.store` | three acorn packs, 1,000 acorns and up, 2 acorns per dust (13 and 23 Sep 2026); two cash packs (250 dust at $1.99, 23 Sep; 2,500 dust at $3.99, 15 Sep) hidden on the web, sticker on the beta | the acorn packs the same; the cash packs through StoreKit once the shell's store answers |
