import { SKY_LUM, ENVS, HELMETS, PHYS, SUITS, TUT_ARM } from "./catalog.js?v=28";
import { drawTrailPreviewOn, drawPalOn } from "./cosmetics.js?v=28";
import { drawSprite, skyImage } from "./art.js?v=28";
...
export function skyLuma(w) {
    const a = SKY_LUM[ENVS[w.envA].sky] ?? 0.2;
    const b = SKY_LUM[ENVS[w.envB].sky] ?? 0.2;
