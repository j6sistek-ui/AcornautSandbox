import { HIGH_ORBIT_PARTS } from './high-orbit-parts.js?v=251';
import { HIGH_ORBIT_HEAD_RADIUS, HIGH_ORBIT_DISPLAY_SPAN } from './high-orbit-config.js?v=251';
import { createHighOrbitMotion } from './high-orbit-motion.js?v=251';
import { paintHighOrbitEffect } from './high-orbit-effects.js?v=251';
