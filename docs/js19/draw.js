import { ENVS, HELMETS, PHYS, SUITS, TUT_ARM } from "./catalog.js?v=19";
import { drawTrailPreviewOn, drawHelmetOn, drawPalOn, helmetCenter } from "./cosmetics.js?v=19";
import { drawSprite } from "./art.js?v=19";
