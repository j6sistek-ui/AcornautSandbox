import { NEW_PLANET_RGB } from "./zone-planet-colors.js?v=275";
import { platform } from "./platform.js?v=275";
import { ORBIT_PILOT_IDS, HIGH_ORBIT_PROFILES, PREMIUM_SUIT_IDS } from "./high-orbit-config.js?v=275";
import { FLIGHT_GRAVITY, QUICK_DROP_VY } from "./control-constants.js?v=275";
...
export const BUILD_TIME = "2026-09-12 05:23 UTC";
...
export function bundleProductIds(b) {
...
export function bundleQuote(b, owns) {
    const ids = bundleIds(b);
...
export const HELMET_SHELF = [
    { title: "CLEAR VISORS", ids: ["clear", "lunar", "gemmie", "phoenix", "sammie", "seraph", "chronarch"] },
