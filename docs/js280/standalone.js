import { selectShopCycle } from "./shop-cycle.js?v=280";
import { spillControlArt, SPILL_CONTROL_LAYOUT } from "./spill-control-art.js?v=280";
import { suitPitchFor, tapShapeFor, tailSpringFor } from "./save.js?v=280";
import { platform } from "./platform.js?v=280";
import { trailWornBy, canWearTrail, builtInTrailSuit } from "./catalog.js?v=280";
import { isHighOrbit, HIGH_ORBIT_PROFILES } from "./high-orbit-config.js?v=280";
import { PLANNED_STAR_REWARDS } from "./star-map-rewards.js?v=280";
import { addChartScenery } from "./star-map-view.js?v=280";
import { mapDebrisIndex } from "./zone-visuals.js?v=280";
import { missionCredit, verifiedMask, routeMasks, rewardId } from "./campaign-progress.js?v=280";
import { STAR_MAP_PREVIEW, suitPitchDefault } from "./catalog.js?v=280";
import { repeatTapMode } from "./sim.js?v=280";
import { suitLean, TAP_SHAPE_MIN, TAP_SHAPE_MAX, TAIL_SPRING_MIN, TAIL_SPRING_MAX, TAIL_SPRING_SUITS } from "./control-constants.js?v=280";
import { CHART_LEVELS, CHART_MAX_STARS, nextLevel, levelAt, reachedGate, SUB_ACORNS } from "./campaign.js?v=280";
import { ART_VER, BUILD, ENVS, GUIDE_HELM, GUIDE_SUIT, HELMETS, HELMET_SHELF, SUIT_SHELF, IAP_ITEMS, IS_BETA, MOD_SHIELD_COST, MODS, PALS, PHYS, SUITS, TRAILS, helmetWornBy, isIap, wearsOwnHead, BUNDLES, bundleIds, idDust, SET_TRAIL, fixedHeadTag, fixedHeadLine, fixedHeadDescription, DUST_PACKS, DAILY_DUST, DAILY_STREAK_BONUS, DAILY_STREAK_LEN, BOOSTS, BOOST_IDS } from "./catalog.js?v=280";
import { paintPortrait, paintTrailPreview, paintPalPreview, paintFlightPreview, paintShipPreview } from "./draw.js?v=280";
import { bundleQuote } from "./catalog.js?v=280";
import { drawSprite as drawSpriteOn } from "./art.js?v=280";
import { createEngine } from "./engine.js?v=280";
import { dualPalUnlocked, equippedPals, deepUnlocked, helmetRevealed, lostUnlocked, palUnlocked, startShieldUnlocked, suitRevealed, starsOf, trailUnlocked, PILOT_NAME_MAX, boostReady, skipEligible, rewardOwned, ownsPremium } from "./save.js?v=280";
import { HYPER_RUN_MAX_ACORNS, HYPER_RUN_MISSION, STAR_REWARDS, STAR_UNLOCKS, countBits, fxText, goalText, levelUnlocked, starTitle, RACE_GATES } from "./campaign.js?v=280";
import { formatRaceTicks } from "./race.js?v=280";
import { SPILL_UTILITIES, spillMastery, spillEngineColor } from "./spill-content.js?v=280";
import { spillPreviewState } from "./spill-presentation.js?v=280";
import { createDepotView, drawDepotWorkshop, drawSpillLaunchSetup, drawSpillEnginePicker, drawSpillFlightHelp, drawSpillGuideSheet } from "./spill-workshop.js?v=280";
...
export async function bootStandalone(root) {
    ...
    function drawHome() {
        ...
        const chart = tile("t-chart", hubIcon("star-chart-holo"), "STAR CHART", nxt ? `Next unlock ★ ${nxt.stars}` : "Complete", () => engine.open("log"), undefined, s.guide === "levels");
