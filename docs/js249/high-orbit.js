import { HIGH_ORBIT_PARTS } from './high-orbit-parts.js?v=249';
import { HIGH_ORBIT_HEAD_RADIUS, HIGH_ORBIT_DISPLAY_SPAN } from './high-orbit-config.js?v=249';
import { createHighOrbitMotion } from './high-orbit-motion.js?v=249';
import { paintHighOrbitEffect } from './high-orbit-effects.js?v=249';
