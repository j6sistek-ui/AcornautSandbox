...
import { STAR_CHART_TRAILS } from "./catalog.js?v=278";
import { paintStarTrailPreview } from "./star-trails.js?v=278";
let ctx;
function use(c) {
    ctx = c;
}
...
function drawCatHead(suit) {
    ...
    ctx.beginPath();
    ctx.moveTo(9.2, -19.0);
    ctx.lineTo(13.0, -29.2);
    ctx.lineTo(16.4, -18.4);
    ctx.closePath();
    ctx.fill();
    ctx.fillStyle = '#eeae94';
    ctx.beginPath();
    ctx.moveTo(11.2, -19.4);
    ctx.lineTo(13.1, -26.0);
    ctx.lineTo(14.8, -19.0);
    ctx.closePath();
    ctx.fill();
    // muzzle
    ctx.fillStyle = suit.belly;
    ...
    ctx.beginPath();
    ctx.moveTo(19.0, -10.4);
    ctx.lineTo(21.6, -10.0);
    ctx.lineTo(20.2, -7.8);
    ctx.closePath();
    ctx.fill();
...
export function canDrawPal(id) { return PAL_VECTORS.has(id); }
...
function drawTrailPreview(id, cx, cy, t) {
    ...
    if (id === 'sparks') {
        ...
        for (let i = 0; i < 4; i++) {
            ...
            ctx.shadowColor = i % 2 ? '#7fffe0' : '#8fb8ff';
            ctx.shadowBlur = 5;
            ctx.fillStyle = i % 3 === 0 ? '#fff5ef' : i % 3 === 1 ? '#7fffe0' : '#8fb8ff';
            ctx.beginPath();
            ctx.moveTo(-4.8, 0);
            ctx.quadraticCurveTo(0, -3.4, 4.3, 0);
            ctx.quadraticCurveTo(0, 2.5, -4.8, 0);
            ctx.fill();
        ...
        for (let i = 0; i < 4; i++) {
            ...
            ctx.strokeStyle = i % 2 ? '#fff0b8' : '#d89a3a';
            ctx.lineWidth = 1;
            for (let k = 0; k < 8; k++) {
                ctx.rotate(Math.PI / 4);
                ctx.strokeRect(r * .7, -.5, 1.8, 1);
            }
            ctx.beginPath();
        ...
        for (let i = 0; i < 4; i++) {
            ...
            ctx.beginPath();
            ctx.moveTo(-5.5, .3);
            ctx.quadraticCurveTo(-.5, -4.3, 4.2, -.7);
            ctx.quadraticCurveTo(1.2, .2, 3.3, 3.1);
            ctx.quadraticCurveTo(-1.1, 2.2, -5.5, .3);
            ctx.fill();
            ctx.restore();
        }
    }
        ...
        for (let i = 0; i < 4; i++) {
            ...
            ctx.beginPath();
            ctx.moveTo(-4.2, 0);
            ctx.quadraticCurveTo(0, -3.5, 4.2, 0);
            ctx.quadraticCurveTo(0, 3, -4.2, 0);
            ctx.fill();
            ctx.strokeStyle = '#16866a';
            ctx.lineWidth = .7;
            ctx.beginPath();
            ctx.moveTo(-3.2, 0);
            ctx.lineTo(3.2, 0);
        ...
        for (let i = 0; i < 4; i++) {
            ...
            ctx.translate(-3 - off, (i % 2 ? -1 : 1) * 4);
            ctx.rotate(ph * 3 + i);
            ctx.strokeStyle = i % 2 ? '#ffe2bd' : '#c77dff';
            ctx.lineWidth = 1.2;
            ctx.shadowColor = '#c77dff';
            ctx.shadowBlur = 5;
            ctx.beginPath();
            ctx.arc(0, 0, r, .5, Math.PI * 1.72);
            ctx.stroke();
            ctx.beginPath();
            ctx.arc(0, 0, r * 1.5, 3.5, 5.7);
            ctx.stroke();
            ctx.restore();
        }
    }
