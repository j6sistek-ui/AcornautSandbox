import { HIGH_ORBIT_DISPLAY_SPAN } from './high-orbit-config.js?v=285';
import { PREMIUM_FLIGHT_DURATION } from './high-orbit-motion.js?v=285';
import { paintHighOrbitEffect } from './high-orbit-effects.js?v=285';
import { PREMIUM_FLIGHT_FRAMES } from './premium-flight-frames.js?v=285';
