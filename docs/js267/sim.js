import { createVanguardMotion, stepVanguard, vanguardTap, vanguardDive, vanguardContact, vanguardGate } from "./vanguard.js?v=267";
import { createArcflashMotion, stepArcflash, arcflashTap, arcflashDive, arcflashContact } from "./arcflash-motion.js?v=267";
import { createHighOrbitMotion, stepHighOrbit, highOrbitTap } from "./high-orbit-motion.js?v=267";
import { isHighOrbit, highOrbitTrailSuit } from "./high-orbit-config.js?v=267";
import { trailWornBy } from "./catalog.js?v=267";
import { missionRandom } from "./mission-rng.js?v=267";
import { recordZoneVisit, routeMasks, settleMissionCredit, earnedCampaignStars, migrateCampaign, barrierId } from "./campaign-progress.js?v=267";
import { CHART_LEVELS, reachedGate } from "./campaign.js?v=267";
import { TUNNEL_LEAD_NODES, TUNNEL_LEAD_BLEND, BOUNCE_ANIM_DURATION, LEGACY_DEBRIS_COUNT, ENVS, ENV_GATES, IS_BETA, RETRO_GATE, TAIL, WARP_GATES, TAP_ANIM_DURATION, TUT_READ, PHYS, TRAILS } from "./catalog.js?v=267";
import { nextFamilyPlanet } from "./planet-family.js?v=267";
import { modsUnlocked, batteryUnlocked, writeSave, grantTutorialKit, equippedPals } from "./save.js?v=267";
import { platform } from "./platform.js?v=267";
import { TUTORIAL_SUIT } from "./catalog.js?v=267";
import { emptyStats, goalMet, goldGatesFor, gateClearedBy } from "./campaign.js?v=267";
import { createRaceState, RACE_DT, queueRaceInput, raceDecisionAge, stepRace, } from "./race.js?v=267";
import { raceViewport, raceViewportY } from "./race-viewport.js?v=267";
import { createSpill, resizeSpill, spillBurst, spillCleared, spillTap, stepSpill, } from "./spill.js?v=267";
import { SPILL_UTILITIES, spillEngineColor } from "./spill-content.js?v=267";
import { WORMHOLE_MAX_VY, WORMHOLE_FLAP, WORMHOLE_GRAVITY, WORMHOLE_SPEED_BASE, WORMHOLE_SPEED_RAMP, WORMHOLE_WIDTH, WORMHOLE_TURN, WORMHOLE_DEBRIS_SPACING, WORM_EVERY_GATES, WORM_CALM_SECONDS, WORM_CALM_SPEED, WORM_EXIT_LEAD, WORM_EXIT_GRACE, } from "./control-constants.js?v=267";
