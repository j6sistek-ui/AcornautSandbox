import { VANGUARD_FRAMES } from "./vanguard.js?v=255";
import { ENVS, PAL_ANIM, DEBRIS_COUNT, LEGACY_DEBRIS_COUNT, PLANET_COUNT, ART_VER, HYPER_RUN_ENABLED } from "./catalog.js?v=255";
import { prepareDepotBear } from "./spill-depot-bear.js?v=255";
import { SPILL_UTILITY_IDS } from "./spill-content.js?v=255";
import { ORBIT_PILOT_IDS, PREMIUM_SUIT_IDS, isPremiumSuit, isHighOrbitRig } from "./high-orbit-config.js?v=255";
