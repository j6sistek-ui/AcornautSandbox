...
import { ENVS, PAL_ANIM, DEBRIS_COUNT, LEGACY_DEBRIS_COUNT, PLANET_COUNT, ART_VER, HYPER_RUN_ENABLED, IS_BETA } from "./catalog.js?v=255";
import { prepareDepotBear } from "./spill-depot-bear.js?v=255";
import { SPILL_UTILITY_IDS } from "./spill-content.js?v=255";
import { HIGH_ORBIT_IDS, isHighOrbit } from "./high-orbit-config.js?v=255";
