import { emptyArt, loadArt } from "./art.js?v=48";
import { sfx, unlockAudio, music } from "./audio.js?v=48";
import { HELMETS, MOD_BATTERY_COST, MOD_SHIELD_COST, SUITS, TRAILS, TUT_ARM } from "./catalog.js?v=48";
import { drawHud, drawWorld } from "./draw.js?v=48";
import { batteryUnlocked, loadSave, palUnlocked, startShieldUnlocked, suitRevealed, writeSave, } from "./save.js?v=48";
import { dive, flap, initStars, makeWorld, pausePlay, resetRun, resumePlay, snapshot, updateWorld, } from "./sim.js?v=48";
...
export { deepUnlocked, lostUnlocked } from "./save.js?v=48";
