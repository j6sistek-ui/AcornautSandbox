import { VANGUARD_FRAMES } from "./vanguard.js?v=290";
import { ENVS, PAL_ANIM, DEBRIS_COUNT, HUB_PLANET, LEGACY_DEBRIS_COUNT, PLANET_COUNT, ART_VER, HYPER_RUN_ENABLED } from "./catalog.js?v=290";
import { prepareDepotBear } from "./spill-depot-bear.js?v=290";
import { SPILL_UTILITY_IDS } from "./spill-content.js?v=290";
import { ORBIT_PILOT_IDS, PREMIUM_SUIT_IDS, isPremiumSuit, isHighOrbitRig } from "./high-orbit-config.js?v=290";
import { bindSpriteDetails, spriteImageFor } from "./sprite-detail.js?v=290";
...
const ASC_BANKS = { eclipse: 8, flight: 3, cyber: 9, porcelain: 9, nacre: 9, origamist: 9, seraph: 8, iontrim: 8, copper: 8,
...
const DESC_BANKS = { eclipse: 8, flight: 5, cyber: 9, porcelain: 9, nacre: 9, origamist: 9, seraph: 8, iontrim: 8, copper: 8,
    voidsuit: 8, alien: 8,
    ember: 8,
    cryostar: 8, verdant: 8, gemmie: 8,
    sammie: 8, frost: 8, ghost: 8, leviathan: 8,
...
const suitBankLoads = new Map();
export function loadSuitBank(bank, id) {
    ...
    const p = (async () => {
        ...
        if (shortBank || !completeMotion || (isPremiumSuit(id) && (!tail || !body)))
            suitBankLoads.delete(id);
    })();
