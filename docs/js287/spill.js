import { VANGUARD_DEPOT_SECONDS } from "./spill-depot-gag.js?v=287";
...
import { ENVS, LEGACY_DEBRIS_COUNT, PHYS } from "./catalog.js?v=287";
import { SPILL_EVENTS, SPILL_SPECIALTIES, SPILL_UTILITIES, SPILL_UTILITY_IDS, spillContractOffers, spillEventFor } from "./spill-content.js?v=287";
// ---------------------------------------------------------------- tuning
export const SPILL = {
...
function stepSpillBody(s, dt) {
    ...
    if (s.thrustT)
        s.thrustT = Math.max(0, s.thrustT - dt);
    if (s.phase === "ready")
        return;
    if (s.phase === "over") {
        s.deadFor += dt;
