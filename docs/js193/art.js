import { VANGUARD_FRAMES } from "./vanguard.js?v=193";
import { PAL_ANIM, BOUNCE_ANIM_ENABLED, DEBRIS_COUNT, PLANET_COUNT, ART_VER, HYPER_RUN_ENABLED, IS_BETA, TAP_ANIM_ENABLED } from "./catalog.js?v=193";
import { prepareDepotBear } from "./spill-depot-bear.js?v=193";
import { SPILL_UTILITY_IDS } from "./spill-content.js?v=193";
