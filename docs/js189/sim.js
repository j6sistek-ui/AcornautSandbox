import { createVanguardMotion, stepVanguard, vanguardTap, vanguardDive, vanguardContact, vanguardGate } from "./vanguard.js?v=189";
import { trailWornBy } from "./catalog.js?v=189";
...
import { createRaceState, queueRaceInput, raceDecisionAge, stepRace, } from "./race.js?v=189";
import { raceViewport, raceViewportY } from "./race-viewport.js?v=189";
import { createSpill, resizeSpill, spillBurst, spillCleared, spillHold, stepSpill, } from "./spill.js?v=189";
import { SPILL_UTILITIES, spillEngineColor } from "./spill-content.js?v=189";
import { WORMHOLE_MAX_VY, WORMHOLE_FLAP, WORMHOLE_GRAVITY, WORMHOLE_SPEED_BASE, WORMHOLE_SPEED_RAMP, WORMHOLE_WIDTH, WORMHOLE_TURN, WORMHOLE_DEBRIS_SPACING, WORM_EVERY_GATES, WORM_CALM_SECONDS, WORM_CALM_SPEED, WORM_EXIT_LEAD, WORM_EXIT_GRACE, } from "./control-constants.js?v=189";
