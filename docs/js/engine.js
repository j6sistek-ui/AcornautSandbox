...
import { hyperRunById, levelById, levelUnlocked, STAR_REWARDS } from "./campaign.js?v=167";
import { dive, flap, initStars, makeWorld, pausePlay, planRaceCueEffects, resizeWorld, resetRun, resumePlay, reviveCost, reviveRun, setRaceInput, snapshot, takeRaceCueEffects, takeSpillCues, updateWorld, } from "./sim.js?v=167";
...
import { spillBuy, spillExtend, spillLeaveDepot, spillLunge, spillPulse, spillReroll } from "./spill.js?v=167";
