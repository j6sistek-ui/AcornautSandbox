import { VANGUARD_FRAMES } from "./vanguard.js?v=245";
import { PAL_ANIM, DEBRIS_COUNT, PLANET_COUNT, ART_VER, HYPER_RUN_ENABLED, IS_BETA } from "./catalog.js?v=245";
import { prepareDepotBear } from "./spill-depot-bear.js?v=245";
import { SPILL_UTILITY_IDS } from "./spill-content.js?v=245";
