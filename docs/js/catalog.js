import { FLIGHT_GRAVITY, QUICK_DROP_VY } from "./control-constants.js?v=208";
...
export const BUILD_TIME = "2026-09-07 01:37 UTC";
...
export const PHYS = {
    ...
    powerDuration: 3.5,
    slowFactor: 0.42,
    // Halved from 10 on the owner's call (idea #3 of the audit list): ten
    // seconds of invulnerability trivialized long stretches. Starpup still
    // doubles it - the relative nerf is accepted.
    goldDuration: 5,
    overdriveGate: 100,
    overdriveSpan: 50,
    magnetR: 200,
...
export const HELMETS = [
    ...
    { id: "phoenix", name: "Phoenix", cost: 175, visor: "#ffd2b0", tint: 0.18, rim: "#c4362a", trim: "#7a1d14", glow: "#ff6a1e" },
    ...
    { id: "princess", name: "Rose", cost: 350, visor: "#fdeef6", tint: 0.16, rim: "#6b3f9e", trim: "#c0348a", glow: "#ff8ad0" },
...
export const SUITS = [
    ...
    { id: "aurorasuit", beta: true, name: "Aurora", cost: 280, fur: "#cf8a3c", furDark: "#9c5f1d", belly: "#f4ddb4", suit: "#0f5c4c", suitLite: "#2fae8f", suitDark: "#073a2f", trim: "#5dffd0", glow: "#5dffd0", dust: "#a8ffe8" },
    ...
    { id: "stardust", beta: true, name: "Stardust", cost: 300, fur: "#c8873f", furDark: "#94601f", belly: "#f2dcb2", suit: "#1a2560", suitLite: "#3d4fa8", suitDark: "#0c1233", trim: "#ffd76a", glow: "#8fb8ff", dust: "#fff3b8" },
    ...
    { id: "alien2", beta: true, name: "Alien 1", cost: 0, alien: true, ownHead: true, fur: "#7ed957", furDark: "#3e8a2a", belly: "#d6f7b0", suit: "#2e6b5a", suitLite: "#57b09a", suitDark: "#173a2e", trim: "#c8ff6a", glow: "#7dff4d", dust: "#b6ff8a" },
...
export const SUIT_SHELF = [
    // Aurora and Stardust are DEMOTED to the beta shelf (owner, 1 Sep 2026):
    // "underwhelming and not working well due to visual drifts". Their
    // helmets stay earned as rewards; the shelf shows a placeholder card in
    // their place until replacements arrive.
    // AcorNut leads the row, earned or not (owner, 7 Sep 2026)
    { title: "STANDARD", ids: ["vanguard", "flight", "iontrim", "copper", "frost", "voidsuit", "ember", "ghost"] },
