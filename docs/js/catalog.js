import { FLIGHT_GRAVITY, QUICK_DROP_VY } from "./control-constants.js?v=191";
export const GAME_VERSION = "v1.2.1-illust";
export const ART_VER = "191";
...
export const BUILD_TIME = "2026-09-06 13:59 UTC";
...
export const SUIT_SHELF = [
    ...
    { title: "FLAGSHIP · 500 STARS", ids: ["vanguard"] },
