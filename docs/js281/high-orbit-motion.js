import { HIGH_ORBIT_PROFILES, isPremiumSuit } from './high-orbit-config.js?v=281';
import { createManeuverMotion, maneuverTap, stepManeuver } from './vanguard-maneuver.js?v=281';
