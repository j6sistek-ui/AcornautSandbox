import { SKY_RGB, ENVS, HELMETS, PHYS, SUITS, TUT_ARM, skyIdFor, washScale, wearsOwnHead } from "./catalog.js?v=53";
import { drawTrailPreviewOn, drawPalOn, drawAstronautOn } from "./cosmetics.js?v=53";
import { drawSprite, skyImage, spriteHalo, SPRITE_HALO_PAD } from "./art.js?v=53";
