import { HIGH_ORBIT_PARTS } from './high-orbit-parts.js?v=252';
import { PREMIUM_PARTS } from './premium-parts.js?v=252';
import { HIGH_ORBIT_HEAD_RADIUS, HIGH_ORBIT_DISPLAY_SPAN, isPremiumSuit } from './high-orbit-config.js?v=252';
import { createHighOrbitMotion } from './high-orbit-motion.js?v=252';
import { paintHighOrbitEffect } from './high-orbit-effects.js?v=252';
