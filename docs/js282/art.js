import { VANGUARD_FRAMES } from "./vanguard.js?v=282";
import { ENVS, PAL_ANIM, DEBRIS_COUNT, HUB_PLANET, LEGACY_DEBRIS_COUNT, PLANET_COUNT, ART_VER, HYPER_RUN_ENABLED } from "./catalog.js?v=282";
import { prepareDepotBear } from "./spill-depot-bear.js?v=282";
import { SPILL_UTILITY_IDS } from "./spill-content.js?v=282";
import { ORBIT_PILOT_IDS, PREMIUM_SUIT_IDS, isPremiumSuit, isHighOrbitRig } from "./high-orbit-config.js?v=282";
