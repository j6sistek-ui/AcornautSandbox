...
export async function bootStandalone(root) {
    ...
    function drawTestLabSheet() {
        ...
        sheet.append(labDoor("FLIGHT TEST", `${wornName} flies itself · hover, 2/4/6/8 taps a second, pairs, station · dials live`, () => { testLabOpen = false; resetArmed = false; engine.startFlightTest(); }, "ac-testlab-go"));
