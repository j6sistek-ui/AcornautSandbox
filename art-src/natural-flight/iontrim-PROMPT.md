...
CHARACTER: Ion (iontrim), the reference orange squirrel in a dark navy flight suit with exact bright cyan piping: cyan shoulder ring, cyan chest chevron and collar edge, long cyan outer thigh loop, dark cuff with cyan band. Keep the dark navy jacket closed in every pose, same seams and panels, same orange paws and same copper-brown fur/tail. Do not add armor, gloves, a backpack, visor or helmet. The reference is the entire design contract.
