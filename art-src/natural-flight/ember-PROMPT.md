...
CHARACTER IDENTITY: Ember: the exact warm orange-brown squirrel in a closed BLACK/CHARCOAL suit with thin ORANGE/GOLD edge piping, matching round shoulder and hip panels, same dark raised collar and wrist cuffs. Preserve every panel outline and orange seam at the same body location. Same orange fur, bare paws and bushy warm tail. No flames, glowing effects, new chest emblem, backpack or color shifts.
