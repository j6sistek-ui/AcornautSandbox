...
CHARACTER IDENTITY: Copper: the exact orange squirrel in fully COPPER/BROWN metallic segmented armor, warm brass edging and circular shoulder and hip plates. Preserve the exact raised round fasteners, chest panels, dark collar, arm rings, thigh plates and copper boots from image 1. Same warm fur and tail. No silver, cyan, extra straps or accessories.
