...
CHARACTER IDENTITY: Ghost: the exact spectral white/pearl squirrel with large dark eye, small pale pink inner ears, smooth pale face and a translucent flowing body and wisp-tail silhouette. Its soft wispy body is the design: NO jacket, armor, colored trim, buttons, helmet or accessories. Preserve the same original wisp branches and translucent pale gray/white palette. Tail motion is a flowing spectral ribbon arc, with its branches continuously connected, no torn/disappearing/reappearing lobes. The head retains its exact individual face and skull scale.
