...
CHARACTER IDENTITY: Void: the exact orange squirrel in deep PURPLE/VIOLET closed flight clothing with GOLD piping, matching shoulder/hip panels, dark standing collar with gold edge, and the same gold chest buckle/strap fasteners. The jacket stays closed, same opening, no added cape or missing chest panel. Same warm fur and tail. Never recolor gold to cyan or violet to gray.
