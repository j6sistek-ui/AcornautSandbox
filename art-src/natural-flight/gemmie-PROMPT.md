...
CHARACTER IDENTITY: Gemmie: the exact orange squirrel in faceted pale OPAL/PEARL iridescent armor and a long crystalline pastel tail. Preserve the original cream, rose-pink, pale yellow, mint and lilac facet colors at their own locations, the same round shoulder/hip fasteners, collar and cuffs. The prism palette must not cycle with pose, and facet topology must not flicker or regenerate. Tail bends through its crystal plume without losing facets or gaining spikes.
