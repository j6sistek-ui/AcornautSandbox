...
CHARACTER IDENTITY: Sammie: the exact orange squirrel in RED lacquer SAMURAI armor, black underlayers, GOLD border lines and fasteners. Preserve the round engraved chest medallion, paired shoulder lamellae, red skirt/hip lamellae, exact black joint gaps and gold trim, wrists and greaves. NO helmet, sword, extra badge, redesign or armor removal. Every plate and fastener remains at its own anatomical location.
