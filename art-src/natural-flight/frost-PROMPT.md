...
CHARACTER IDENTITY: Frost: the exact WHITE/ICE-BLUE squirrel with white fur, pale blue-gray shaded tail, silver-white flight suit with pale blue rounded shoulder/hip panels and tube seams, silver wrist cuffs, and the same dark eye. Keep all white/pale blue shades fixed and distinguish fur from suit. Never add warm fur, stripes, extra jacket openings or new hardware. Maintain the exact shoulder disc, sleeve rings and collar.
