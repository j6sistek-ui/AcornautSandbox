...
export async function bootStandalone(root: HTMLElement) {
  ...
  const MODES: { id: "fly" | "deep" | "lost" | "arcade" | "tunnel"; label: string; short: string; blurb: string }[] = [
    ...
    { id: "tunnel", label: "WORMHOLE RUN", short: "TUNNEL", blurb: "Tap to rise. Dodge debris. Survive the tunnel." },
  ];
  let selectedMode = 0;
