import { xpCumulative, BUILD, GAME_VERSION, HELMETS, NEWS, PALS, SUITS, TRACK, TRAILS, isIap } from "./catalog";
...
export async function bootStandalone(root: HTMLElement) {
  ...
  const MODES: { id: "fly" | "deep" | "lost" | "arcade"; label: string; blurb: string }[] = [
