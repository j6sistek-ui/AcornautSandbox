...
export async function bootStandalone(root: HTMLElement) {
  ...
  if (IS_BETA) document.body.classList.add("ac-beta");
  root.innerHTML = "";
  ...
  function drawHangar() {
    ...
    box.append(scroll);
    if (!IS_BETA) box.append(tabbar("hangar"));
    return box;
  }
  ...
  function drawLog() {
    ...
    box.append(scroll);
    if (!IS_BETA) box.append(tabbar("log"));
  ...
  function drawShop() {
    ...
    box.append(scroll);
    if (!IS_BETA) box.append(tabbar("shop"));
    return box;
  }
  ...
  function drawProfile() {
    ...
    box.append(scroll);
    if (!IS_BETA) box.append(tabbar("profile"));
    return box;
  }
  ...
  function drawHelp() {
    ...
    if (!IS_BETA) box.append(tabbar("none"));
    return box;
  }
