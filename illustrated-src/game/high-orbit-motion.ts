 ...
 * tail follows travel and recoil instead of a free-running sine. Premium frames share only its accepted
...
export type HighOrbitMotion = {
  ...
  /** AcorNut locomotion and thrust gesture; never used by premium frames. */
