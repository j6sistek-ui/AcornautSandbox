...
const DOME: Record<string, [number, number, number]> = {
  ...
  "seraph-asc-1": [200, 133, 50],
  "seraph-asc-2": [200, 130, 50],
  "seraph-asc-3": [200, 127, 50],
  "seraph-asc-4": [201, 136, 50],
  "seraph-asc-5": [200, 133, 50],
  "seraph-asc-6": [200, 130, 50],
  "seraph-asc-7": [200, 127, 50],
  "seraph-asc-8": [199, 124, 50],
  "seraph-desc-1": [200, 133, 50],
  "seraph-desc-2": [200, 136, 50],
  "seraph-desc-3": [200, 139, 50],
  "seraph-desc-4": [200, 142, 50],
  "seraph-desc-5": [199, 145, 50],
  "seraph-desc-6": [198, 148, 50],
  "seraph-desc-7": [199, 158, 50],
  "seraph-desc-8": [197, 162, 50],
