...
function drawSpillWorld(ctx: CanvasRenderingContext2D, w: World, save: SaveData, art: ArtBank) {
  ...
  for (const n of s.nuts) {
    ...
    else if (n.kind === "shield") drawSprite(ctx, frameOf(art.shieldAnim, w.time, 10) ?? art.shieldnut, n.x, y, 34);
    else {
...
function drawSpillHud(ctx: CanvasRenderingContext2D, w: World, art?: ArtBank | null) {
  ...
  if (s.phase === "card") {
    ...
    ctx.restore();
    if (s.hintT > 0) drawSpillHint(ctx, w, s.hint, Math.min(1, t * 2), hudY - 10);
  }
  if (s.phase === "respawn") {
    ctx.textAlign = "center";
...
const DOME: Record<string, [number, number, number] | [number, number, number, number]> = {
  ...
  "cryostar-desc-1": [191, 94, 40],
  "cryostar-desc-2": [187, 121, 40, 15],
  "cryostar-desc-3": [186, 148, 40, 25],
  "cryostar-desc-4": [185, 141, 40, 25],
  "cryostar-desc-5": [186, 144, 40, 25],
  "cryostar-desc-6": [192, 143, 40, 20],
  "cryostar-desc-7": [186, 146, 40, 25],
  "cryostar-desc-8": [179, 145, 40, 25],
  ...
  "verdant-desc-1": [186, 92, 40],
  "verdant-desc-2": [187, 110, 40, 15],
  "verdant-desc-3": [183, 140, 40, 25],
  "verdant-desc-4": [180, 147, 40, 30],
  "verdant-desc-5": [176, 141, 40, 30],
  "verdant-desc-6": [179, 145, 40, 30],
  "verdant-desc-7": [170, 150, 40, 35],
  "verdant-desc-8": [177, 149, 40, 30],
  ...
  "gemmie-desc-1": [183, 102, 40],
  "gemmie-desc-2": [176, 134, 40, 25],
  "gemmie-desc-3": [178, 151, 40, 30],
  "gemmie-desc-4": [177, 148, 40, 30],
  "gemmie-desc-5": [176, 149, 40, 30],
  "gemmie-desc-6": [179, 152, 40, 30],
  "gemmie-desc-7": [175, 159, 40, 35],
  "gemmie-desc-8": [167, 153, 40, 35],
  ...
  "sammie-desc-1": [186, 102, 38],
  "sammie-desc-2": [177, 135, 38, 20],
  "sammie-desc-3": [180, 136, 38, 25],
  "sammie-desc-4": [178, 138, 38, 25],
  "sammie-desc-5": [189, 140, 38, 20],
  "sammie-desc-6": [178, 144, 38, 25],
  "sammie-desc-7": [171, 149, 38, 30],
  "sammie-desc-8": [171, 156, 38, 35],
