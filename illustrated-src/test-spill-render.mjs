...
const root=resolve(dirname(fileURLToPath(import.meta.url)),'..');const output=process.env.ACORNAUT_QA_OUTPUT || join(tmpdir(),'acornaut-spill-render');mkdirSync(output,{recursive:true});const Art=await import('../docs/js/art.js');const Draw=await import('../docs/js/draw.js');const Save=await import('../docs/js/save.js');const Sim=await import('../docs/js/sim.js');const S=await import('../docs/js/spill.js');
...
const {prepareDepotBear}=await import('../docs/js/spill-depot-bear.js');
