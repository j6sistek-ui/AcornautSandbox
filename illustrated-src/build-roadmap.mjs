...
try {
  ...
  md += '\n## Full beta playtest\n\nOpen `/beta/` → Star Chart. All 260 missions are playable immediately; no proposal page or sample toggle. Every zone uses six flight missions, one Lost in Space, one black-hole/Deep Space, one Arcade and one Debris Field mission. This is a first-pass mix for playtesting.\n\n';
  ...
  md += '- Blackout flashing is removed. Existing steady fog, pace, gap width and sway provide variety. Beta additionally tests the owner’s requested springy/sticky planets, upside-down flight, and tap-to-slow. Switchback is now a cosmetic premium companion without an effect.\n';
  md += '- Ordinary Debris Field (mode id "spill") remains endless with untimed Depots and a once-per-save first-pass milestone at wave 20. Production’s nine existing Debris Field missions keep their explicit 4/5/6/7/8/9/10/11/20-wave targets, Ore/no-hit objectives and seeds 5018–5098. No zone-based Debris Field generator exists.\n';
