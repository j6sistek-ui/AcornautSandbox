import { ART_VER, BUILD, ENVS, GAME_VERSION, HELMETS, IAP_ITEMS, IS_BETA, MOD_BATTERY_COST, MOD_SHIELD_COST, MODS, NEWS, PALS, PHYS, SUITS, TRAILS, helmetWornBy, isIap, wearsOwnHead } from "./catalog.js?v=59";
import { paintPortrait, paintTrailPreview, paintPalPreview } from "./draw.js?v=59";
import { drawSprite as drawSpriteOn } from "./art.js?v=59";
