import { xpCumulative, ART_VER, BUILD, ENVS, GAME_VERSION, HELMETS, MOD_BATTERY_COST, MOD_SHIELD_COST, NEWS, PALS, PHYS, SUITS, TRACK, TRAILS, isIap, wearsOwnHead } from "./catalog.js?v=50";
    ...
    function drawHangar() {
        ...
        if (engine.shopTab === "helmets") {
            ...
            for (const h of HELMETS) {
                ...
                b.onclick = () => { if (!locked && (!premium || owned))
