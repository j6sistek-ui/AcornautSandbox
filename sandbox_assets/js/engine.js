...
import { sfx, unlockAudio } from "./audio.js?v=26";
import { HELMETS, MOD_BATTERY_COST, MOD_SHIELD_COST, SUITS, TRAILS, TUT_ARM } from "./catalog.js?v=26";
import { drawHud, drawWorld } from "./draw.js?v=26";
import { batteryUnlocked, loadSave, palUnlocked, startShieldUnlocked, suitRevealed, writeSave, } from "./save.js?v=26";
import { dive, flap, initStars, makeWorld, pausePlay, resetRun, resumePlay, snapshot, updateWorld, } from "./sim.js?v=26";
...
export { deepUnlocked, lostUnlocked } from "./save.js?v=26";
