import { loadArt } from "./art.js?v=20";
import { sfx, unlockAudio } from "./audio.js?v=20";
import { HELMETS, MOD_BATTERY_COST, MOD_SHIELD_COST, SUITS, TRAILS, TUT_ARM } from "./catalog.js?v=20";
import { drawHud, drawWorld } from "./draw.js?v=20";
import { batteryUnlocked, loadSave, palUnlocked, startShieldUnlocked, suitRevealed, writeSave, } from "./save.js?v=20";
import { dive, flap, initStars, makeWorld, pausePlay, resetRun, resumePlay, snapshot, updateWorld, } from "./sim.js?v=20";
...
export { deepUnlocked, lostUnlocked } from "./save.js?v=20";
