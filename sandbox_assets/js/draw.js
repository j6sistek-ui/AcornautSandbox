import { SKY_RGB, ENVS, HELMETS, PHYS, SUITS, TUT_ARM } from "./catalog.js?v=29";
import { drawTrailPreviewOn, drawPalOn } from "./cosmetics.js?v=29";
import { drawSprite, skyImage } from "./art.js?v=29";
