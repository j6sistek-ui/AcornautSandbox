...
function spawnPair(w, save, x) {
    ...
    if (topY - r > 90)
        push(Math.max(28, (topY - r) * 0.45), 24, (Math.random() - 0.5) * 20);
    if (topY - r > 160)
        push(Math.max(48, (topY - r) * 0.7), 20, (Math.random() - 0.5) * 26);
    push(botY + r + 34, 26, 18);
    push(botY + r + 40, 22, -20);
    if (w.H - (botY + r) > 90)
        push(Math.min(w.H - 28, botY + r + (w.H - botY - r) * 0.55), 24, (Math.random() - 0.5) * 20);
    if (w.H - (botY + r) > 160)
        push(Math.min(w.H - 48, botY + r + (w.H - botY - r) * 0.75), 20, (Math.random() - 0.5) * 26);
