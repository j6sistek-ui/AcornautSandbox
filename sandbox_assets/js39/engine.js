...
import { dive, flap, initStars, makeWorld, pausePlay, resetRun, resumePlay, snapshot, updateWorld, } from "./sim.js?v=39";
...
export { deepUnlocked, lostUnlocked } from "./save.js?v=39";
